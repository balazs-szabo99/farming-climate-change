...
chart_info = {
    "cereal_yield_and_temperature": {
        ...
        "description": (
            ...
            "the 'Temperature' data represents the average temperature in "
            "degrees Celsius. By visualizing these two factors together, we can "
    ...
    "temperature_and_water_usage": {
        ...
        "description": (
            ...
            "data indicates the average temperature in degrees Celsius, while "
            "the 'Water Usage' data represents the total water usage in cubic "
            "meters per person. By visualizing these two factors together, we can "
            "gain insights into the relationship between climate change and "
            "water usage."
        ),
    },
